...
--
-- Host: 127.0.0.1:3308
-- Generation Time: Nov 29, 2020 at 02:50 AM
...
INSERT INTO `categorys` (`id`, `parent_id`, `category_name`, `image_category`, `description`, `status`, `created_at`, `updated_at`) VALUES
...
INSERT INTO `category_translations` (`id`, `category_id`, `locale`, `parent_id`, `category_name`, `image_category`, `description`, `status`, `created_at`, `updated_at`) VALUES
(1, 1, 'en', 1, 'Smartphone', '/upload/category/637037652457717299_11-den.png', '\r\nSmart phone products', 1, '2020-09-01 00:00:00', '2020-11-11 09:17:01'),
(2, 2, 'en', 1, 'Tablet', '/upload/category/637340486124696106_ss-tab-s7-den-1.png', 'Tablet products', 1, '2020-09-03 00:00:00', '2020-11-11 09:17:22'),
(3, 3, 'en', 1, 'Smart Watch', '/upload/category/637361528559053699_apple-watch-se-gps-cellular-40mm-hong-1.png', 'Smart Watch product', 1, '2020-09-03 00:00:00', '2020-11-11 09:18:22'),
(4, 4, 'en', 1, 'Laptop', '/upload/category/apple-macbook-air-2020-i3-220174-1-600x600.jpg', 'Laptop product', 1, '2020-09-03 00:00:00', '2020-11-11 09:18:44'),
(6, 6, 'en', 1, 'Audio', '/upload/category/register-bg.jpg', 'Audio product', 1, '2020-09-03 00:00:00', '2020-11-11 09:19:56');
...
INSERT INTO `product_lang` (`id`, `created_at`, `updated_at`) VALUES
...
(6, 'Nokia', 'h1', 'Nokia Corporation là một tập đoàn đa quốc gia có trụ sở tại Keilaniemi, Espoo, Phần Lan. Nokia tập trung vào các sản phẩm viễn thông không dây và cố định, với 129.746 nhân viên làm việc ở 120 quốc gia, bán sản phẩm ở hơn 150 quốc gia trên toàn cầu và đạt doanh số 41 tỷ euro với lợi tức 1,2 tỷ năm 2009', 'Espoo, Phần Lan', '19000015', 'nokia@gmail.com.vn', 0, '2020-09-01 00:00:00', '2020-11-27 13:10:56'),
...
--
-- Table structure for table `translate_product`
--
...
--
-- Dumping data for table `translate_product`
--
