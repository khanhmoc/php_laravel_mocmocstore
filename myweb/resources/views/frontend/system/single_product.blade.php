                    ...
                    <div class="quick-image">
                            ...
                            <div class="list-img">
                                <div class="product-img tab-content">
                                    <div class="simpleLens-container tab-pane fade in" id="sin-1">
                                        ...
                                        <a class="simpleLens-image" data-lens-image="{{$product->pro_image}}" href="#"><img src="{{$product->pro_image}}" alt="" class="simpleLens-big-image"></a>
                                    </div>
                        ...
                        <div class="quick-thumb">
                            <ul class="product-slider">
                                <li><a data-toggle="tab" href="#sin-1"> <img src="{{$product->pro_image}}" alt="quick view" /> </a></li>
                ...
                <div class="col-xs-12 col-sm-7 col-md-8">
                    <div class="quick-right">
                        <div class="list-text">
                            ...
                            <div class="list-btn">
                                <a class="addtocart" data-href="{{ route('f.addtocartajax') }}" data-id="{{($product->id)}}">Thêm vào giỏ hàng</a>
                                <a href="#">wishlist</a>
                                <a href="#" data-toggle="modal" data-target="#quick-view{{($product->id)}}">zoom</a>
                            </div>
                                    ...
                                    <div class="col-xs-12 col-sm-7 col-md-8">
                                        <div class="quick-right">
                                            <div class="list-text">
                                                ...
                                                <div class="list-btn">
                                                    <a class="addtocart" data-href="{{ route('f.addtocartajax') }}" data-id="{{($product->id)}}">add to cart</a>
                                                    <a href="#">wishlist</a>
                                                    <a href="#">zoom</a>
                                                </div>
                                                <div class="share-tag clearfix">
